...
**[`parity-matrix.md`](parity-matrix.md) is the committed snapshot of that
output** — 86 exact, 18 accepted, 0 unexplained across 104 calls. Regenerate it
only when the result changes; ordinary runs leave it alone.
